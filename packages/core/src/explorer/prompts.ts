...
- Use propose_goal when you observe a distinct user-visible surface not covered by an existing goal: a modal, banner, footer link, secondary nav, content area, settings panel, export button, or shareable URL. When Discovery provided surface or journey ids, include surface_id or journey_id so the report can connect the new goal back to the product map. The orchestrator caps total goals as a safety; this prompt should not pre-suppress real additions.

...
- When Discovery provides a PRODUCT USE CONTRACT, treat it as the acceptance criteria for real product use. Complete the primary value loop before awarding a high-confidence verified status. A selected toolbar button, opened menu, focused element, mode switch, landing page, or settings panel is weak proof unless the contract says that is the actual outcome.
